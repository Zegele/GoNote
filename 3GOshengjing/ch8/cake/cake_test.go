...
var defaults = cake.Shop{
	...
	Cakes:        20,
	BakeTime:     10 * timeMillisecond,
	NumIcers:     1,
	Icetime:      10 * timeMillisecond,
	InscribeTime: 10 * timeMillisecond,
}
...
func BenchmarkSlowIcingManyIcers(b *testing.B) {
	...
	cakeshop := defaults
	cakeshop.IceTiem = 50 * time.Millisecond
	cakeshop.NumIcers = 5
	cakeshop.Work(b.N) // 228ms
